...
namespace Game.ActorModel.Actors
{
    public class SignalRBridgeActor : ReceiveActor
    {
        ...
        public SignalRBridgeActor(
            IGameEventsPusher gameEventsPusher, 
            IActorRef gameController)
        {
            ...
            Receive<PlayerStatusMessage>(
                ...
                {
                    _gameEventsPusher.
                        PlayerJoined(message.PlayerName, message.Health);
                });
            ...
            Receive<PlayerHealthChangedMessage>(
                ...
                {
                    _gameEventsPusher.
                        UpdatePlayerHealth(message.PlayerName, message.Health);
                });
        }
    }
}
